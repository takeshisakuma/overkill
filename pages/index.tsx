...
import serviceIconAnimation from "../animation/serviceIconAnimation";
import countdownTimerAnimation from "../animation/countdownTimerAnimation";
import eventAnimation from "../animation/eventAnimation";
import browserAnimation from "../animation/browserAnimation";
  ...
  return (
    <>
      ...
      <ProviderSection
        ...
        paragraphText={[
          `Internet Explorer以外のモダンな主要Webブラウザーには、2013年以降も新しい機能が数多く追加され続けています。${"\n"}そのため、あなたのサービスで「Webで最新の機能を提供したい」と考えるなら、Internet Explorerの対応は諦める必要があります。`,
